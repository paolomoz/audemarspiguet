...
const m1 = JSON.parse(readFileSync('stardust/current/content-manifest.json','utf8'));
const m2 = JSON.parse(readFileSync('stardust/current/content-manifest-2.json','utf8'));
...
await page.goto('file://' + resolve('stardust/current/pages/ch-en-collections-code-11-59-collection-hydrated.html'));
...
`;
writeFileSync('stardust/prototypes/code-11-59-collection-proposed.html', html);
