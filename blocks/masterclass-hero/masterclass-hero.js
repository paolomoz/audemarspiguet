 ...
 */
import { ICON_TYPE, ICON_CLOCK, MC_TYPE_LABELS, MC_LEVEL_LABELS } from '../carousel/carousel.js';
...
export default async function decorate(block) {
  ...
  title.className = 'mch-title grid-container';
  if (backLink) {
  ...
  cardWrap.className = 'mch-card-slot grid-container';
