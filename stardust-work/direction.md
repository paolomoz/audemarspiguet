...
_provenance:
  ...
  readArtifacts:
    - stardust-work/current/pages/ch-en-collections-code-11-59-collection.json
    - stardust-work/current/css-lift-1440.json
    - stardust-work/current/css-lift-360.json
---
...
Permitted deltas: ONLY the entries of stardust-work/replica/inconsistency-register.md
...
- Product data: the 3 live `.products.*.json` endpoints are snapshotted in
  stardust-work/current/data/ and will be served from the EDS origin (CORS on
